...
export function Footer() {
  return (
    <footer className="max-w-7xl mx-auto bg-card/10 border-t rounded-t-lg border-white/5 flex flex-wrap pt-16 pb-8 relative overflow-hidden">
          ...
          {[
            ...
            { 
             ...
             <div key={idx} className="col-span-6 md:col-span-2 flex flex-col gap-4">
                <h4 className="text-xs font-bold text-foreground/70 uppercase tracking-widest">
                    {section.title}
                </h4>
